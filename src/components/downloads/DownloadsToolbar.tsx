...
const SORT_OPTIONS = [
  ...
  { value: 'size-high', label: 'File Size: High to Low' },
  { value: 'size-low', label: 'File Size: Low to High' },
] as const;

export function DownloadsToolbar() {
  return (
    <section
      aria-label="Downloads toolbar"
    ...
    >
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="relative min-w-0 flex-1 lg:max-w-md">
          <label htmlFor="downloads-search" className="sr-only">
            Search downloads
          </label>
          <Search
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <div className="min-w-[10rem] flex-1 sm:flex-none">
            <label htmlFor="downloads-sort" className="sr-only">
              Sort downloads
            </label>
            <select
              id="downloads-sort"
